...
module InstructionRAM
  ...
  initial begin
    ...
    $readmemb("machine_code1.txt",RAM);        // use to test normal functions like add, srl...
    // $readmemb("machine_code2.txt",RAM);           // test MEM_to_EX and WB_to_EX data hazards
    // $readmemb("machine_code3.txt",RAM);        // test lw stall
    // $readmemb("machine_code4.txt",RAM);        // test resgister file simutaneously write and read
    // $readmemb("machine_code5.txt",RAM);       // test beq and bne instrction
    // $readmemb("machine_code6.txt",RAM);        // test data hazard about jump instruction
    // $readmemb("machine_code7.txt",RAM);        // test data hazard about jr
    //  $readmemb("machine_code8.txt",RAM);           // test data hazard about branch
  end
